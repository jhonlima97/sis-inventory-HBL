...
$cod        = htmlspecialchars($_POST['cod_patrimonial'], ENT_QUOTES, 'UTF-8');
...
$resol      = htmlspecialchars($_POST['resolucion'], ENT_QUOTES, 'UTF-8');
$area       = htmlspecialchars($_POST['area_id'], ENT_QUOTES, 'UTF-8');
$estado     = htmlspecialchars($_POST['estado'], ENT_QUOTES, 'UTF-8');

// Corrige el orden de los parámetros
$consulta = $MN->modificar_scanner($cod,$marca,$modelo,$serie, $sis_ope, $velocidad, $resol, $area, $estado);
